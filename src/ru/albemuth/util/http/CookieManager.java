 ...
 * <pre>
 *                  use
 * java.net.CookieHandler <------- HttpURLConnection
 *       ^
 *       | impl
 *       |         use
 ...
 * <ul>
 * <li>
 * java.net.CookieHandler is at the core of cookie management. User can call
 * java.net.CookieHandler.setDefault to set a concrete CookieHanlder implementation
 * to be used.
 * </li>
 * <li>
 ...
 * <blockquote>
 * <ul>
 * <li>Use java.net.CookieHandler.setDefault to set a brand new {@link java.net.CookieHandler} implementation
 ...
 *       java.net.CookieHandler.setDefault(new CookieManager(new MyCookieStore(), new MyCookiePolicy()));
 *     </pre></blockquote>
 * <li>Let CookieManager be the default {@link java.net.CookieHandler} implementation, but
 * use customized {@link CookiePolicy}:
 * <blockquote><pre>
 *       // this should be done at the beginning of an HTTP session
 *       java.net.CookieHandler.setDefault(new CookieManager());
 *       // this can be done at any point of an HTTP session
 *       ((CookieManager)java.net.CookieHandler.getDefault()).setCookiePolicy(new MyCookiePolicy());
 *     </pre></blockquote>
 * </ul>
 * </blockquote>
 * <p/>
            ...
            for (String headerValue : responseHeaders.get(headerKey)) {
                try {
                    ...
                    try {
                        ...
                        LOGGER.error("Invalid cookie for " + uri + ": " + headerValue);
                    }
